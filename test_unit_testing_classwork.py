...
def test_get_x(p1, p2, expected):
    from unit_testing_classwork import get_x
    answer = get_x(p1, p2)
    assert answer == expected
...
def test_get_y(p1, p2, expected):
    from unit_testing_classwork import get_y
    answer = get_y(p1, p2)
    assert answer == expected
...
def test_find_slope(p1, p2, expected):
    from unit_testing_classwork import find_slope
...
def test_find_intercept(p1, p2, expected):
    from unit_testing_classwork import find_intercept
